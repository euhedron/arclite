...
/// redundancy, inconsistencies, staleness, gaps, dead weight, and opportunities to consolidate,
/// restructure, clarify, or tighten. Reach for it to harden a codebase or its docs against their
/// own sloppiness.
