...
/// standards a repo enforces — into discrete, repo-agnostic rules. Output is *candidate*
/// rules for a human to curate into a rules dir; they shape every future run, so quality matters.
